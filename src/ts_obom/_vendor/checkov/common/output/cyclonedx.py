...
# ts-obom: CheckType re-exported by output/report.py, imported from its own module
# here so that this file does not pull in report.py (junit_xml/tabulate/termcolor,
# none of which ts-obom needs). Same object either way.
